  ...
  function page_even() {
    ...
    for(var i=0;i<total_page-1;i++){
      if(total_page>8&&current_page>6&&i<current_page-3){
        if(i<2){
          append_html+='<button class="page_num" onclick="page_select(' + (i+1) + ',' + per_num +')">'+(i+1)+'</button>';
        }
        else if(i==2){
        ...
        if(i==current_page-1){
          append_html+='<button class="page_num current_page" onclick="page_select(' + (i+1) + ',' + per_num +')" >'+(i+1)+'</button>';
        }
        else{
          append_html+='<button class="page_num" onclick="page_select(' + (i+1) + ',' + per_num + ')">'+(i+1)+'</button>';
        }
